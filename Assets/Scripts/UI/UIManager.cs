...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject downPanal;
    [SerializeField]
    private GameObject npcDialoguePanal;
    [SerializeField]
    ...
    {
        Destroy(curItemDrag.gameObject); // destory Icon
    }
    ...
    {
        downPanal.SetActive(!flag);
        npcDialoguePanal.SetActive(flag);
